...
You can test our [development version](https://demo.yetiforce.com) and report all problems you find using the [Issues tab](https://github.com/YetiForceCompany/YetiForce/issues) in our [GitHub repository](https://github.com/YetiForceCompany/YetiForce).
...
You can also help other community members by answering the questions posted in the [Issues](https://github.com/YetiForceCompany/YetiForce/issues) and [Discussion](https://github.com/YetiForceCompany/YetiForce/discussions) tabs in our repository. If you know how to solve a problem someone else has posted, or have an idea what could be causing the issue, go ahead and leave your comment in the comments section.
