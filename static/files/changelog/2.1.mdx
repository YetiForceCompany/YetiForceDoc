...
```
YetiForce regularly releases new versions of the software. Each new version includes bug fixes, enhancements and new functionalities. YetiForce 2.3 was released on 13 October 2015. The list of changes for other releases can be found in different articles in the same sub-menu.
Changes 2.2 > 2.3
NEW FUNCTIONALITIES:
...
Added a mechanism that allows for logging on any user: https://gitdeveloper.yetiforce.com/index.php?module=Users&view=SwitchUsers&parent=Settings&block=4&fieldid=94
OPTIMIZATION:
...
ISSUES:
Fixed many reported bugs and issues, the full list can be found here: https://github.com/YetiForceCompany/YetiForceCRM/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22YetiForce+2.3+GA%22
Removed 'my settings' tab [it can be enabled in: config/security.php]
Removed the ability to reset passwords while logging in [it can be enabled in: config/security.php]
```