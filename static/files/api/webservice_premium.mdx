```
{
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "x-session-info",
                        "in": "header",
                        "description": "Get session life information",
                        "schema": {
                            "$ref": "#/components/schemas/Header-Session-Info"
                        }
                    },
                    {
                        "name": "x-session-uptime",
                        "in": "header",
                        "description": "Whether to update session life",
                        "schema": {
                            "$ref": "#/components/schemas/Header-Session-Uptime"
                        }
                    }
                ],
                "requestBody": {
        ...
        "/webservice/WebservicePremium/{moduleName}/Record/{recordId}": {
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "x-raw-data",
                        "in": "header",
                        "description": "Get additional raw data",
                        "schema": {
                            "$ref": "#/components/schemas/Header-Raw-Data"
                        }
                    },
                    {
                        "name": "x-parent-id",
                        ...
                        "schema": {
                            "$ref": "#/components/schemas/Header-Parent-Id"
                        }
                    },
                    {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "426": {
                        "description": "Error while validating data",
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/ExceptionForSave"
                                }
                            },
                            "application/xml": {
                                "schema": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "x-row-count",
                        "in": "header",
                        "description": "Whether to get the number of records",
                        "required": false,
                        "schema": {
                            "type": "integer",
                            "enum": [
                    ...
                    },
                    {
                        "name": "x-fields-info",
                        "in": "header",
                        "description": "Return additional field details",
                        "required": false,
                        "schema": {
                            "type": "integer",
                            "enum": [
                    ...
                    },
                    {
                        "name": "x-response-params",
                        "in": "header",
                        "description": "The header contains information about additional data to be returned in the response [Json array], depends on header `x-response-params`",
                        "required": false,
                        "content": {
                            "application/json": {
                                "schema": {
    ...
    "components": {
        "schemas": {
            ...
            "Header-Session-Info": {
                "title": "Header - Get session life information",
                "description": "Get session life information",
                "type": "integer",
                "default": 1,
                "enum": [
            ...
            "Header-Session-Uptime": {
                "title": "Header - Whether to update session life",
                "description": "Whether to update session life",
                "type": "integer",
                "default": 0,
                "enum": [
            ...
            "Exception": {
                ...
                "properties": {
                    "status": {
                        "title": "0 - error",
                        "description": "Webservice premium container - Get elements of menu class.",
                        "type": "integer",
                        "enum": [
                            0
                        ],
            ...
            "ExceptionForSave": {
                "title": "Save - Edit view pre save exception",
                "required": [
                    "status",
                    "error"
                ],
                    ...
                    "error": {
                        ...
                        "properties": {
                            ...
                            "message": {
                                ...
                                "type": "string",
                                "example": "A record with this name already exists"
                            }
                        },
                        "type": "object"
                    }
                ...
                "properties": {
                    ...
                    "result": {
                        ...
                        "properties": {
                            ...
                            "changeValueEventFields": {
                                "title": "Change value event fields list, depends on header `x-response-params`",
                                "type": "object",
                                "example": "['name']"
                            }
                        },
            ...
            "Field_Info": {
                ...
                "properties": {
                    ...
                    "searchOperator": {
                        "description": "Default operator for your search engine",
                        "type": "string",
                        "example": "c"
                    },
                    "picklistvalues": {
                    ...
                    "displayType": {
                        "description": "Field display type, depends on header `x-response-params`",
                        "type": "integer",
                        "example": 1
                    },
                    "sequence": {
                    ...
                    "queryFieldName": {
                        "description": "Field name for search engine queries, depends on header `x-response-params`",
                        "type": "string"
                    },
                ...
                "properties": {
                    ...
                    "result": {
                        ...
                        "properties": {
                            ...
                            "fieldsDetails": {
                                "title": "Field details for returned columns",
                                "description": "Depends on header `x-fields-info`",
                                "type": "object",
                                "additionalProperties": {
                                    "$ref": "#/components/schemas/Field_Info"
                                }
    ...
    "externalDocs": {
        ...
        "url": "https://doc.yetiforce.com/api/?urls.primaryName=Webservice%20Premium"
    }
}
```
