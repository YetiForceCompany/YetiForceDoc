...
- **PHP `7.4` (recommended), `8.0`**, `8.1` (tests pending). The latest stable versions are recommendeda (eg. `7.4.x`).
...
```ini reference title="Latest stable version: https://github.com/YetiForceCompany/YetiForceCRM/blob/stable/tests/setup/php/prod.ini"
https://github.com/YetiForceCompany/YetiForceCRM/blob/stable/tests/setup/php/prod.ini
```

```ini reference title="Development version: https://github.com/YetiForceCompany/YetiForceCRM/blob/developer/tests/setup/php/dev.ini"
