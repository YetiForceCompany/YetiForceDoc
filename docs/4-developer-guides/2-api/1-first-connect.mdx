...
W treści zapytania umieszczamy dane w formacie JSON:
...
Nazwa użytkownika i hasło przekazywane w treści zapytania to dane ustalone w sekcji administracyjnej w zakładce `Web service - użytkownicy`.
